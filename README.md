<p align="center">
  <picture>
    ...
    <img src="docs/assets/cover-light.svg" alt="Color Format Converter — Hex · Rgb · Hsl — Convert And Preview Live, in the Terminal Workbench style" width="100%">
  </picture>
</p>

<p align="center">
  <a href="https://real-fruit-snacks.github.io/color-format-converter/"><strong>Live site</strong></a> ·
...
Convert a color between hex, RGB, and HSL with a live swatch, and check WCAG 2.1 contrast against black and white. Styled with the
...
**Offline / airgapped:** grab the zip from the [latest release](https://github.com/Real-Fruit-Snacks/color-format-converter/releases/latest)
