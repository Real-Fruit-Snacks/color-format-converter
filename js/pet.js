(function () {
  ...
  function readSize() {
    var s = parseInt(localStorage.getItem("col-pet-size"), 10);
  ...
  var COLOR_COUNT = 6;
  var petColor = 0;
  try { petColor = parseInt(localStorage.getItem("col-pet-color"), 10) || 0; }
  ...
  function cyclePetColor() {
    ...
    applyPetColor();
    try {
      if (petColor) localStorage.setItem("col-pet-color", String(petColor));
      else localStorage.removeItem("col-pet-color");
    } catch (e) { /* private mode */ }
  }
  ...
  function applyOpacity() {
    var o = parseInt(localStorage.getItem("col-pet-opacity"), 10);
    if (!(o >= 15 && o <= 100)) o = 70;
    document.documentElement.style.setProperty("--pet-base-opacity", (o / 100).toFixed(3));
  }
  function readCfg() {
    cfgNap = boolKey("col-pet-nap", true);
    cfgFlee = boolKey("col-pet-flee", true);
    cfgRead = boolKey("col-pet-read", true);
    cfgTricks = boolKey("col-pet-tricks", true);
    cfgSpeech = boolKey("col-pet-speech", false);
    var c = parseInt(localStorage.getItem("col-pet-color"), 10);
